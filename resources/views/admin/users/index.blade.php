    ...
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">
                Kelola akun admin, gudang, dan driver.
            </p>
        </div>
            ...
            <table class="min-w-full border-separate border-spacing-y-3">
                <thead>
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-xs font-bold uppercase tracking-[0.18em] text-slate-500">Email</th>
                        <th class="px-4 py-2 text-left text-xs font-bold uppercase tracking-[0.18em] text-slate-500">Role</th>
