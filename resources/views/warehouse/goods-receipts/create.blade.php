...
<div class="space-y-6">
    <div>
        ...
        <h2 class="text-2xl font-bold text-slate-900">Tambah Barang Masuk</h2>
        <p class="mt-1 text-sm text-slate-500">Input barang masuk untuk gudang Anda.</p>
    </div>

    <div class="glass-panel rounded-[24px] border border-white/50 p-6 shadow-lg">
        <form action="{{ route('warehouse.goods-receipts.store') }}" method="POST" class="space-y-6">
            @csrf
